...
let textScale;
const windowRate = 0.87;

function zoneResizing() {
    pageOriginHeight = document.querySelector('.page-size').offsetHeight;
    pageOriginWidth = document.querySelector('.page-size').offsetWidth;
